...
// 120px thumb zone (top + bottom) so finger control on mobile doesn't cover the paddle.
// Symmetric so Versus both players have breathing room on their own phone.
export const THUMB_ZONE = 120;
export const PADDLE_OFFSET_FROM_WALL = THUMB_ZONE + 24;
